...
# ============================================================================
# ERROR LOGGING SYSTEM - Local file logging for debugging
# ============================================================================

# Create logs directory in the same folder as bot.py
...
PROXY_LIST_FILE = os.path.join(SCRIPT_DIR, "proxies.txt")

class ProxyManager:
    """Manage and rotate through a list of proxies for API calls"""
    
    def __init__(self, proxy_file: str = PROXY_LIST_FILE):
        self.proxies = []
    ...
    def get_all_proxies(self) -> list:
        """Get all proxies for parallel requests"""
...
class GoogleSheetsManager:
    ...
    async def get_worksheet_async(self, sheet_name: str, timeout_seconds: int = 10, max_retries: int = 3) -> list:
        """Async version with timeout protection (Python 3.11+)
