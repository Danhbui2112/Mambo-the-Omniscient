...
LOGGING_CHANNEL_ID = 1015997100456165488  # Channel to send successful command logs
REQUEST_CHANNEL_ID = 1015993980049174539  # Channel for club data requests
DEBUG_LOG_CHANNEL_ID = 1454170907827245320  # Channel for failed commands / debug logs
    ...
    try:
        ...
        for idx, club_config in enumerate(all_configs, start=2):  # Start from row 2 (after header)
            ...
            try:
                ...
                rank = circle_data.get('monthly_rank', 0) or 0
